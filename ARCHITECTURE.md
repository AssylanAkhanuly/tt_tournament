...
- **`TOURNAMENT_AGE_CATEGORY`** — возрастная категория соревнования
  ...
  году, это наше допущение, QUESTIONS 5.17). Участник в категорию не
...
erDiagram
    ...
    RATING_PROFILE {
        ...
        string sex "общий рейтинг ведётся по полу (п. 7.1)"
        date birthDate "сверка с возрастной категорией соревнования"
