...
/** Все роли показываются на светлой теме ✳ (30.08.2026): экраны переехали на
    новый слой (kit/hero/app — HeroUI, светлый), и тёмный тулбар делал нечитаемой
    обвязку борда вокруг светлых макетов. Начиналось со спортсмена (22.08.2026,
    flows/14-sportsmen.md) — теперь тема прибита каждому. */
const light = () => `
