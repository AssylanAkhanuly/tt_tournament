/* Э14.1 → Э14.5 · два состояния мобильного экрана, которых не хватало.
   ...
   2. ЧТО, ЕСЛИ НИКУДА НЕ ВЫЗЫВАЛИ. Тут два разных случая, и путать их нельзя:
      ...
      · турнира нет вовсе, межсезонье — экран ниже. Вызывать некуда, и поле
        ...
        и что с моей заявкой. Кнопка синяя, а не зелёная: зелёное в этой системе
        значит «идите к столу», а идти пока некуда.
  ...
  return (
    <Screen cls="m3o">
      ...
      <div className="mbr-sheet">
        {/* Кнопка синяя: зелёное значит «идите к столу», а идти некуда. */}
        <button type="button" className="mbr-go m3o-go" data-to="Э14.4">
