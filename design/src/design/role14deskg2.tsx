    ...
    <RoleScreen variant={variant} role={R14} nav="Главная" title="Ким Георгий" sub="Астана · СКА · КМС">
      <div className="g2d o14-nohead">
        ...
        <div className="g2d-sheet">
          {/* Действие стоит на листе целиком, а не верхом на границе планов.
              На телефоне кнопка во всю ширину, и половина на тёмном читается;
              здесь она короткая, тёмно-синяя и лежала на тёмно-синем поле —
              нижний край поля резал её пополам, и кнопка выглядела обрезанной
              (заливка от поля отличается всего в 2.7 : 1). На белом листе тот
              же цвет даёт 6.2 : 1 и читается кнопкой без всяких подпорок. */}
