...
/** Язычок «Идёт» на верхней грани карточки — главный приём референса: значок
    сидит НА границе, наполовину снаружи, и не отнимает у карточки строку.

    Ставится внутрь карточки, у которой есть `position: relative`. */
