/* UI-кит присланного спортивного приложения ✳ (30.08.2026).
   ...
   Второй слой дизайн-системы. Первый — «Основа», готовые компоненты HeroUI;
   здесь то, чего в библиотеках нет и быть не может: значок идущего матча,
   карточка встречи, таблица группы. Разделять их по смыслу, а не по
   происхождению: человек ищет «карточку матча», а не «наш компонент».
