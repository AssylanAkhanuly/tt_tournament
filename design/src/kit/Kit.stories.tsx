/* UI-кит присланного спортивного приложения ✳ (30.08.2026).
   ...
   Тема прибита к тёмной: кит тёмный по своей природе, и переключатель темы к
   нему отношения не имеет — его цвета не семантические `--c-*`, а свои. */
  ...
  render: () => (
    <KitCanvas>
      <p className="k-note">
        ...
        <b>язычок</b> — на верхней грани каждой идущей карточки. Точка пульсирует: на
