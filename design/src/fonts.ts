...
/* Inter, а не системный ✳ (30.08.2026): макеты смотрят и принимают в одной
   гарнитуре, иначе на разных машинах один и тот же экран набран по-разному —
   Segoe UI на Windows, San Francisco на маке, — и обсуждать плотность и
   кегли бессмысленно. Переключатель «Шрифт» в тулбаре продолжает работать:
   примерить другую гарнитуру можно, но по умолчанию везде Inter. */
