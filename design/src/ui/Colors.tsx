...
const GROUPS: Group[] = [
  ...
  {
    title: 'Стекло и фон',
    note: 'Панели полупрозрачные: цвет собирается из белого с малой альфой поверх экранного градиента.',
    tokens: [
      ['--c-glass', 'карточка, плитка, строка'],
      ['--c-glass-2', 'выделенная панель, таб-бар'],
