...
export const R13: RoleUI = {
  ...
  nav: [
    ...
    /* Соревнования разделены по делу, а не по объекту (решение 18.08.2026).

       Одним разделом «Соревнования» они не читались: в нём лежали и подача
       заявок со сроками, и календарь сезона, и таблица дивизиона, и турниры
       наших — четыре разных дела под одной вкладкой. Теперь их два, и вопрос у
       каждого свой:

       «Заявки» — что клуб подаёт и до какого числа: команда в дивизион, состав
       команды на сезон, состав на каждый из четырёх туров (Э13.5 · Э13.4).
       «Турниры» — что впереди и как идут дела: календарь сезона целиком, тур,
       турнир с нашими, команды и таблица дивизиона (Э13.6 · Э13.7 · Э13.9 ·
       Э13.3). */
    [<ClipboardCheck size={18} />, 'Заявки'],
