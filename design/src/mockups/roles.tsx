...
export const R13: RoleUI = {
  ...
  nav: [
    ...
    /* Один раздел на все соревнования, а не три пункта подряд.

       Команды Лиги, календарь туров и турниры, где играют люди клуба, — про
       одно и то же: где выступает клуб. Тремя пунктами меню это выглядело как
       три разные области работы, и человек каждый раз вспоминал, в котором из
       них искать. Внутри раздела — переключатель видов (Э13.3 · Э13.6 · Э13.9),
       как «Список / Сетка месяцев» в календаре. */
