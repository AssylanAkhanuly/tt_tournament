...
export const R10: RoleUI = {
  ...
  /* Один пункт ✳: у инспектора одна работа — смотреть турнир, который он
     контролирует. Ход, журнал правок и заключение относятся к **одному**
     турниру, и пунктами меню они превращались в три списка «по всем турнирам
     сразу» — а инспектор так не работает: он открывает свой старт и остаётся
     в нём. Теперь это разделы самого турнира, вход в них — из списка. */
  nav: [[<Eye size={18} />, 'На контроле']],
};
