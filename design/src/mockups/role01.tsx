...
import {
  AlertTriangle, ChevronDown, Copy, Download, Eye, FileSpreadsheet, GitMerge, Image, Link2, Merge,
  Plus, Search, Send, UserPlus,
} from 'lucide-react';
import {
...
const REGISTRIES: Registry[] = [
  {
    ...
    rows: [
      { av: A(32), nm: 'Смагулов Алан', sub: '2004 · Алматы · «Алатау» · тренер Смагулов А. · КМС', val: 'рейтинг 2456', st: 'ВЗНОС ОПЛАЧЕН', cls: 'live' },
      { av: A(44), nm: 'Ким Георгий', sub: '2003 · Астана · СКА · тренер Гладун И. · МС', val: 'рейтинг 2401', st: 'ВЗНОС ОПЛАЧЕН', cls: 'live' },
      { av: A(13), nm: 'Пак Сергей', sub: '2005 · Павлодар · «Иртыш» · тренер Ким Л. · КМС', val: 'рейтинг 2312', st: 'ВЗНОС ОПЛАЧЕН', cls: 'live' },
      { av: A(22), nm: 'Жумабеков Расул', sub: '2007 · Караганда · «Шахтёр» · тренер Досжан М. · 1 разряд', val: 'рейтинг 2290', st: 'ВЗНОС НЕ ОПЛАЧЕН', cls: 'wait' },
      { av: AW(21), nm: 'Тлеуова Аружан', sub: 'завёл клуб «Достык», 03.02.2026 · 2009 · Шымкент · 2 разряд', val: 'рейтинг 1980', st: 'ВЗНОС НЕ ОПЛАЧЕН', cls: 'wait' },
      { av: A(75), nm: 'Ерлан Бекзат', sub: '2006 · Актобе · спортшкола №3 · тренер Токаев М. · 1 разряд', val: 'рейтинг 2105', st: 'ВЗНОС ОПЛАЧЕН', cls: 'live' },
    ],
  },
  {
    ...
    rows: [
      { av: A(76), nm: 'Оспанов Тимур', sub: 'Национальная категория · Астана · в наряде: Кубок РК', val: 'рейтинг 27,5', st: 'ПОДТВЕРЖДЁН', cls: 'live' },
      { av: A(13), nm: 'Пак Сергей', sub: 'Первая категория · Павлодар · стол 4, Лига 2-й тур', val: 'рейтинг 18', st: 'ПОДТВЕРЖДЁН', cls: 'live' },
      { av: AW(65), nm: 'Абдрахманова Сауле', sub: 'Первая категория · Караганда', val: 'рейтинг 12,5', st: 'ПОДТВЕРЖДЁН', cls: 'live' },
      { av: A(19), nm: 'Цой Виктор', sub: 'Первая категория · Караганда', val: 'рейтинг 9,5', st: 'ПОДТВЕРЖДЁН', cls: 'live' },
      { av: A(22), nm: 'Жумабеков Расул', sub: 'Судья по спорту · Караганда', val: 'рейтинг 7', st: 'ПОДТВЕРЖДЁН', cls: 'live' },
      { av: AW(32), nm: 'Абдрахманова Айгерим', sub: 'Вторая категория · Астана · документ на проверке', val: 'рейтинг 4', st: 'НЕ ПОДТВЕРЖДЁН', cls: 'wait' },
    ],
  },
  {
    k: 'Тренеры', n: '96', add: 'Завести тренера',
    rows: [
      { av: A(51), nm: 'Смагулов Асхат', sub: 'Алматы · «Алатау»', val: '24 спортсмена', st: 'АКТИВЕН', cls: 'live' },
      { av: A(19), nm: 'Гладун Игорь', sub: 'Астана · СКА', val: '18 спортсменов', st: 'АКТИВЕН', cls: 'live' },
      { av: AW(65), nm: 'Ким Лариса', sub: 'Павлодар · «Иртыш»', val: '12 спортсменов', st: 'АКТИВЕН', cls: 'live' },
      { av: A(45), nm: 'Досжан Марат', sub: 'Караганда · «Шахтёр» · учётная запись отключена', val: '9 спортсменов', st: 'ТРЕБУЕТ ПРОВЕРКИ', cls: 'wait' },
      { av: A(76), nm: 'Токаев Марат', sub: 'Актобе · спортшкола №3', val: '15 спортсменов', st: 'АКТИВЕН', cls: 'live' },
    ],
  },
  {
    ...
    rows: [
      { nm: '«Алатау»', sub: 'клуб · Алматы · 3 команды в Лиге', val: '86 спортсменов', st: 'ЗАРЕГИСТРИРОВАН', cls: 'live' },
      { nm: '«Барыс»', sub: 'клуб · Астана · 2 команды в Лиге', val: '64 спортсмена', st: 'ЗАРЕГИСТРИРОВАН', cls: 'live' },
      { nm: '«Шахтёр»', sub: 'клуб · Караганда · 1 команда в Лиге', val: '41 спортсмен', st: 'ЗАРЕГИСТРИРОВАН', cls: 'live' },
      { nm: '«Иртыш»', sub: 'клуб · Павлодар · 1 команда в Лиге', val: '38 спортсменов', st: 'ЗАРЕГИСТРИРОВАН', cls: 'live' },
      { nm: '«Достык»', sub: 'клуб · Шымкент · команд в Лиге нет', val: '29 спортсменов', st: 'ЗАРЕГИСТРИРОВАН', cls: 'live' },
      { nm: 'Спортшкола №3', sub: 'организация, не клуб · Актобе · документы на проверке', val: '52 спортсмена', st: 'НЕ ПОДТВЕРЖДЕНА', cls: 'wait' },
    ],
  },
];
