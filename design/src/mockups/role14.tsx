...
const NEWS = [
  {
    ...
    sub: 'восемь главных стартов, четыре тура Лиги и двадцать ОРТ',
    at: '15 апреля',
    tag: 'КАЛЕНДАРЬ',
  },
  {
    nm: 'Годовой взнос: срок до 31 марта',
    sub: 'без оплаты заявки на турниры со взносом не проходят',
    at: '2 марта',
    tag: 'ВЗНОСЫ',
  },
  {
  ...
  },
  {
    ...
    sub: 'результаты, призёры и разбор финала',
    at: '24 февраля',
    tag: 'РЕЗУЛЬТАТЫ',
  },
];
