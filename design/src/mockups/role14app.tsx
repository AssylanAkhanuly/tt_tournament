/* Роль 14 · Спортсмен — МОБИЛЬНОЕ ПРИЛОЖЕНИЕ (нарисовано впрок).

   Сейчас проектируем веб: борд роли в `role14.tsx` — десктопный. Приложение
   (TZ §10) остаётся на потом, но экраны уже нарисованы и лежат здесь, чтобы
   не рисовать их заново. Показываются отдельной историей «Приложение · позже».
...
/** Борд приложения: те же экраны, но телефоном. Пока справочный. */
export function Role14AppBoard() {
  return (
    <div className="board">
      ...
      <div className="row">
        ...
        <Col cap="Э14.1 · Главная"><Home14_1 /></Col>
        <Col cap="Э14.2 · Календарь"><Calendar14_2 /></Col>
        <Col cap="Э14.3 · Заявка на ОРТ"><Apply14_3 /></Col>
        <Col cap="Э14.4 · Моя заявка"><MyApp14_4 /></Col>
        <Col cap="Э14.5 · Мой турнир и матч"><Match14_5 /></Col>
        <Col cap="Э14.6 · Аналитика"><Stats14_6 /></Col>
        <Col cap="Э14.7 · Профиль и взнос"><Profile14_7 /></Col>
      </div>
    </div>
  );
}
