...
const DEP = A(22);     // Жумабеков Расул — заместитель, пользователь этих экранов
...
export function Rating8_3() {
  return (
    <RoleScreen
      ...
      sub="Жумабеков Расул · судья национальной категории · сезон 2026"
