...
/** Данные роли — те же, что в старом слое (`roles.tsx`), тип — из нового.
    Подписи пунктов — те же слова: по ним их находит карта флоу.
    ...
    списка разъехались бы на первой же правке. «История» стоит разделом, а не
    только кнопкой над счётом: у неё свой экран (Э9.4). */
const R09: RoleUI = {
  num: '9',
  title: 'Судья',
...
/** Содержимое «Моих турниров» — одно на оба формата: назначения, строка баллов
    и переход в кабинет судьи. Разделы роли живут в оболочке — сайдбаром на
    десктопе и нижними вкладками на телефоне, — а не внутри экрана. */
const Tours9_1Body = () => {
