...
export function Draw7_2() {
  ...
  return (
    <RoleScreen role={R07} nav="Жеребьёвка" title="Жеребьёвка">
...
const VIEW73 = ['Дерево', 'Таблица групп'];
...
export function Bracket7_3() {
  ...
  return (
    <RoleScreen role={R07} nav="Сетка" title="Сборка сетки">
      <Chips
        items={[
          { v: '128', k: 'Участников', tone: 'b' },
          { v: '7', k: 'Раундов' },
      ...
      {view === VIEW73[0] ? <Tree7_3 /> : <GroupTables7_3 />}
    </RoleScreen>
  );
}
