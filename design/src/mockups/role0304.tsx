...
const Subs3_3States = () => (
  <States>
    ...
    >
      <Rows>
        <Row nm="Кубок Республики Казахстан 2026" sub="подписка включена · уведомления о состоянии и протоколе" pill={{ t: 'ПОДПИСКА', cls: 'live' }} />
      </Rows>
      <Alert tone="danger">
        «Отписаться» — единственная кнопка роли: она меняет только собственные уведомления, а не
        турнир.
      </Alert>
    </Shot>
  </States>
