...
export const FINDINGS: Finding[] = [
  ...
  },
  {
    ...
    did:
      'Не сделано, и это осознанно. Одноцветной выворотки в комплекте ФНТ не существует — ни ' +
      'в присланном .cdr, ни в наших сборках. Титульных экранов с крупным знаком в макетах ' +
      'пока нет, поэтому вариант не рисовали: это рекомендация на будущее. Понадобится — ' +
      'собирается из тех же кривых эмблемы.',
    done: false,
    refs: [
      { app: 'MLS', url: S('9d6fba4f-0a08-4102-ac7e-117e15ac6b3e') },
      { app: 'theScore', url: S('85c01f98-aeef-419d-8297-de2f5d081324') },
