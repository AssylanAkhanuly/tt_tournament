...
/* Хук сессии: один источник на всю страницу.
   ...
   Оболочка экрана и карточка спортсмена спрашивают «кто вошёл» одновременно.
   Отдельный запрос из каждого компонента дал бы два ответа, которые на время
   могут разойтись: в меню уже «Выйти», а в карточке ещё нет кнопок
   председателя. Поэтому
